...
if (!r.ok)
throw new Error(d.error_description || d.message || “Sign in failed”);
...
method: “POST”, headers: { “Content-Type”: “application/json”, “apikey”: SUPA_KEY },
body: JSON.stringify({ email, password, data: (options === null || options === void 0 ? void 0 : options.data) || {} })
});
const d = await r.json();
if (!r.ok)
throw new Error(d.error_description || d.message || “Sign up failed”);
if (d.access_token) {
setToken(d.access_token);
_session = { user: d.user, access_token: d.access_token };
_authListeners.forEach(fn => fn(“SIGNED_IN”, _session));
...
order: (col, opts) => { _filters.push(`order=${col}.${(opts === null || opts === void 0 ? void 0 : opts.ascending) === false ? "desc" : "asc"}`); return q; },
then: (resolve, reject) => {
const params = _filters.length ? “?” + _filters.join(”&”) : “”;
const h = Object.assign(Object.assign({}, headers()), { “Accept”: _single ? “application/vnd.pgrst.object+json” : “application/json” });
if (_single)
...
const d = await r.json();
if (!r.ok)
return resolve({ data: null, error: d });
return resolve({ data: d, error: null });
}).catch(reject);
},
insert: async (payload) => {
const r = await fetch(`${SUPA_URL}/rest/v1/${table}`, {
method: “POST”, headers: Object.assign(Object.assign({}, headers()), { “Prefer”: “return=representation” }),
...
method: “PATCH”, headers: Object.assign(Object.assign({}, headers()), { “Prefer”: “return=representation” }),
body: JSON.stringify(payload)
}).then(async (r) => {
const d = await r.json();
...
delete: () => {
const dq = {
eq: (col, val) => { *filters.push(`${col}=eq.${encodeURIComponent(val)}`); return dq; },
then: (resolve) => {
const params = *filters.length ? “?” + *filters.join(”&”) : “”;
return fetch(`${SUPA_URL}/rest/v1/${table}${params}`, {
...
if (page === “loading”)
return (React.createElement(“div”, { style: { background: “#08080f”, minHeight: “100vh”, display: “flex”, alignItems: “center”, justifyContent: “center” } },
React.createElement(“style”, null, CSS),
React.createElement(SLogo, { size: 60 })));
if (page === “auth”)
...
return (React.createElement(“div”, { style: { background: “linear-gradient(160deg,#1a0a2e 0%,#08040e 100%)”, minHeight: “100vh”, display: “flex”, flexDirection: “column”, alignItems: “center”, justifyContent: “center”, padding: “0 24px”, color: “#fff” } },
React.createElement(“style”, null, CSS),
...
mode === 1 && (React.createElement(“input”, { value: name, onChange: e => setName(e.target.value), placeholder: “Full name”, style: { width: “100%”, padding: “13px 16px”, background: “rgba(255,255,255,0.7)”, border: “1px solid rgba(255,255,255,0.12)”, borderRadius: 12, color: “#fff”, fontSize: 14, outline: “none” } })),
...
return (React.createElement(“div”, { style: { background: “linear-gradient(160deg,#1a0a2e,#08040e)”, minHeight: “100vh”, display: “flex”, flexDirection: “column”, color: “#fff” } },
React.createElement(“style”, null, CSS),
...
React.createElement(“div”, { style: { flex: 1, padding: “32px 24px 40px”, overflowY: “auto” } },
...
React.createElement(“input”, { value: name, onChange: e => setName(e.target.value), style: { width: “100%”, padding: “13px 16px”, background: “rgba(255,255,255,0.7)”, border: “1px solid rgba(255,255,255,0.15)”, borderRadius: 12, color: “#fff”, fontSize: 15, outline: “none”, marginBottom: 14 }, placeholder: “Your stage name” }),
...
React.createElement(“input”, { value: handle, onChange: e => setHandle(e.target.value.replace(/[^a-z0-9*]/gi, “”).toLowerCase()), style: { width: “100%”, padding: “13px 16px 13px 28px”, background: “rgba(255,255,255,0.7)”, border: “1px solid rgba(255,255,255,0.15)”, borderRadius: 12, color: “#fff”, fontSize: 15, outline: “none” }, placeholder: “yourhandle” }))),
...
React.createElement(“div”, { style: { display: “flex”, flexWrap: “wrap”, gap: 10, marginBottom: 24 } }, ROLES.map(r => (React.createElement(“button”, { key: r, onClick: () => setRole(r), style: { padding: “10px 16px”, background: role === r ? “linear-gradient(135deg,#c9a84c,#e8a87c)” : “rgba(255,255,255,0.6)”, border: `1px solid ${role === r ? "transparent" : "rgba(255,255,255,0.12)"}`, borderRadius: 24, color: role === r ? “#1a0a2e” : “rgba(255,255,255,0.7)”, fontWeight: role === r ? 700 : 400, fontSize: 13, cursor: “pointer”, transition: “all 0.15s” } }, r)))),
...
React.createElement(“textarea”, { value: bio, onChange: e => setBio(e.target.value), rows: 5, style: { width: “100%”, padding: “13px 16px”, background: “rgba(255,255,255,0.7)”, border: “1px solid rgba(255,255,255,0.15)”, borderRadius: 12, color: “#fff”, fontSize: 14, outline: “none”, resize: “none”, marginBottom: 20, lineHeight: 1.6 }, placeholder: “Tell your story \u2014 your training, credits, what you’re working on, what you’re looking for\u2026” }),
...
React.createElement(“input”, { value: location, onChange: e => setLocation(e.target.value), style: { width: “100%”, padding: “13px 16px”, background: “rgba(255,255,255,0.7)”, border: “1px solid rgba(255,255,255,0.15)”, borderRadius: 12, color: “#fff”, fontSize: 14, outline: “none”, marginBottom: 24 }, placeholder: “City, State (e.g. San Diego, CA)” }),
(bio || location) && (React.createElement(“div”, { style: { background: “rgba(255,255,255,0.4)”, border: “1px solid rgba(255,255,255,0.1)”, borderRadius: 16, padding: “16px”, marginBottom: 8 } },
...
? React.createElement(“img”, { src: avatar, style: { width: “100%”, height: “100%”, objectFit: “cover” } })
...
setSaving(true);
const uid = (_a = session === null || session === void 0 ? void 0 : session.user) === null || *a === void 0 ? void 0 : *a.id;
if (uid) {
const cleanHandle = handle
? (handle.startsWith(”@”) ? handle : “@” + handle)
: “@” + (name || “user”).toLowerCase().replace(/[^a-z0-9*]/g, “*”);
...
React.createElement(“div”, { style: { background: “rgba(255,255,255,0.4)”, border: “1px solid rgba(255,255,255,0.1)”, borderRadius: 16, padding: “16px” } },
...
React.createElement(“div”, { style: { width: 52, height: 52, borderRadius: “50%”, border: “2px solid #c9a84c”, overflow: “hidden”, background: “rgba(201,168,76,0.15)”, flexShrink: 0, display: “flex”, alignItems: “center”, justifyContent: “center” } }, avatar ? React.createElement(“img”, { src: avatar, style: { width: “100%”, height: “100%”, objectFit: “cover” } }) : React.createElement(“span”, { style: { fontSize: 22 } }, “\uD83D\uDC64”)),
...
return (React.createElement(“div”, { style: { background: “#08080f”, minHeight: “100vh”, display: “flex”, flexDirection: “column”, color: “#fff” } },
React.createElement(“style”, null, CSS),
React.createElement(“header”, { style: { background: “linear-gradient(180deg,rgba(8,4,14,0.98),rgba(18,7,36,0.98))”, borderBottom: “1px solid rgba(255,255,255,0.7)”, position: “sticky”, top: 0, zIndex: 100 } },
React.createElement(“div”, { style: { display: “flex”, alignItems: “center”, justifyContent: “space-between”, maxWidth: 480, margin: “0 auto”, padding: “10px 16px 9px” } },
...
tab === 0 && React.createElement(FeedScreen, { videos: videos, setVideos: setVideos, comments: comments, setComments: setComments, show: show }),
...
return (React.createElement(“div”, { style: { height: “calc(100vh - 72px)”, position: “relative”, overflow: “hidden” }, onWheel: e => { if (e.deltaY > 28)
...
videos.map((vid, idx) => {
var _a;
return (React.createElement(VideoCard, { key: vid.id, vid: vid, active: idx === cur, offset: idx - cur, liked: !!liked[vid.id], reposted: !!reposted[vid.id], commentCount: ((_a = comments[vid.id]) === null || *a === void 0 ? void 0 : *a.length) || 0, onLike: () => toggleLike(vid), onComment: () => setModal({ type: “comments”, vid }), onShare: () => doShare(vid), onRepost: () => doRepost(vid), onGift: () => setModal({ type: “gift”, vid }), onSubscribe: () => setModal({ type: “subscribe”, vid }), onProfile: () => setModal({ type: “profile”, vid }) }));
}),
React.createElement(“div”, { style: { position: “absolute”, right: 7, top: “50%”, transform: “translateY(-50%)”, display: “flex”, flexDirection: “column”, gap: 6 } }, videos.map((*, i) => React.createElement(“div”, { key: i, onClick: () => setCur(i), style: { width: 4, height: i === cur ? 20 : 4, borderRadius: 3, background: i === cur ? “#c9a84c” : “rgba(255,255,255,0.25)”, cursor: “pointer”, transition: “height 0.2s” } }))),
...
vid.type === “video” && vid.media_url && (React.createElement(“video”, { ref: vidRef, src: vid.media_url, style: { width: “100%”, height: “100%”, objectFit: “cover”, display: “block” }, playsInline: true, loop: true, muted: false, poster: vid.thumbnail_url || undefined })),
vid.type === “audio” && vid.media_url && (React.createElement(“audio”, { ref: audRef, src: vid.media_url, loop: true })),
vid.type !== “video” && vid.thumbnail_url && (React.createElement(“img”, { src: vid.thumbnail_url, style: { width: “100%”, height: “100%”, objectFit: “cover”, position: “absolute”, inset: 0 } }))),
...
? React.createElement(“img”, { src: vid.avatar_url, style: { width: “100%”, height: “100%”, objectFit: “cover” } })
: vid.avatar),
...
localComments.length === 0 && React.createElement(“div”, { style: { textAlign: “center”, color: “rgba(255,255,255,0.3)”, padding: 32 } }, “No comments yet. Be first! \u2728”),
...
const handleFile = (e) => {
var _a;
const f = (_a = e.target.files) === null || _a === void 0 ? void 0 : *a[0];
if (!f)
return;
setVideoFile(f);
...
useEffect(() => () => {
var _a;
(_a = streamRef.current) === null || *a === void 0 ? void 0 : *a.getTracks().forEach(t => t.stop());
clearInterval(recTimer.current);
}, []);
...
React.createElement(“div”, { style: { background: “rgba(255,255,255,0.3)”, borderRadius: 14, padding: “14px 16px”, marginBottom: 14 } },
React.createElement(“div”, { style: { height: 36, background: “rgba(255,255,255,0.6)”, borderRadius: 8, position: “relative”, marginBottom: 12, overflow: “hidden” } },
...
React.createElement(“div”, { style: { position: “absolute”, inset: “5px 0”, display: “flex”, gap: 1, padding: “0 3px”, opacity: 0.35 } }, Array.from({ length: 50 }).map((*, i) => React.createElement(“div”, { key: i, style: { flex: 1, borderRadius: 1, height: `${20 + Math.sin(i * 0.5) * 60}%`, background: “#c9a84c”, alignSelf: “flex-end” } }))),
...
“#”,
t,
React.createElement(“button”, { onClick: () => setTags(p => p.filter((*, j) => j !== i)), style: { background: “none”, border: “none”, color: “rgba(255,255,255,0.4)”, fontSize: 13, cursor: “pointer”, lineHeight: 1 } }, “\u00D7”)))),
...
[“Allow Comments”, “Others can comment”, allowComments, () => setAllowComments(p => !p)]].map(([label, sub, val, fn]) => (React.createElement(“div”, { key: label, style: { display: “flex”, alignItems: “center”, justifyContent: “space-between”, padding: “12px 16px”, borderBottom: “1px solid rgba(255,255,255,0.4)” } },
React.createElement(“div”, null,
...
useEffect(() => () => {
var _a;
(_a = streamRef.current) === null || _a === void 0 ? void 0 : *a.getTracks().forEach(t => t.stop());
clearInterval(recTimer.current);
cancelAnimationFrame(animRef.current);
}, []);
const publish = async (saveToProfile = false) => {
...
var _a;
const f = (*a = e.target.files) === null || *a === void 0 ? void 0 : *a[0];
if (!f)
return;
setAudioFile(f);
...
“#”,
t,
React.createElement(“button”, { onClick: () => setTags(p => p.filter((*, j) => j !== i)), style: { background: “none”, border: “none”, color: “rgba(255,255,255,0.4)”, fontSize: 13, cursor: “pointer” } }, “\u00D7”)))),
React.createElement(“div”, { style: { display: “flex”, gap: 8, marginBottom: 14 } },
React.createElement(“input”, { value: tagIn, onChange: e => setTagIn(e.target.value), onKeyDown: e => { if (e.key === “Enter”)
addTag(); }, placeholder: “Add tag\u2026”, style: Object.assign(Object.assign({}, inputSt), { marginBottom: 0 }) }),
React.createElement(“button”, { onClick: addTag, style: { padding: “0 14px”, background: “rgba(201,168,76,0.15)”, border: “1px solid rgba(201,168,76,0.3)”, borderRadius: 12, color: “#c9a84c”, fontWeight: 700, fontSize: 18, cursor: “pointer” } }, “+”)),
...
logoImg && React.createElement(“img”, { src: logoImg, style: { height: 36, objectFit: “contain”, marginBottom: 4 } }),
...
React.createElement(“label”, { style: { width: 38, height: 38, borderRadius: 10, background: “rgba(255,255,255,0.7)”, border: `2px solid ${bgImg ? "#c9a84c" : "rgba(255,255,255,0.12)"}`, cursor: “pointer”, display: “flex”, alignItems: “center”, justifyContent: “center”, fontSize: 16, flexShrink: 0 }, title: “Custom background photo” },
React.createElement(“input”, { type: “file”, accept: “image/*”, style: { display: “none” }, onChange: handleBgImg }),
“\uD83D\uDDBC”),
React.createElement(“label”, { style: { width: 38, height: 38, borderRadius: 10, background: “rgba(255,255,255,0.7)”, border: `2px solid ${logoImg ? "#4cb8c4" : "rgba(255,255,255,0.12)"}`, cursor: “pointer”, display: “flex”, alignItems: “center”, justifyContent: “center”, fontSize: 16, flexShrink: 0 }, title: “Add logo/crest” },
...
React.createElement(“button”, { onClick: () => setShowPrev(p => !p), style: { marginLeft: “auto”, padding: “5px 12px”, background: “rgba(255,255,255,0.6)”, border: “1px solid rgba(255,255,255,0.1)”, borderRadius: 20, color: “rgba(255,255,255,0.5)”, fontSize: 11, cursor: “pointer” } },
showPrev ? “Hide” : “Show”,
“ preview”)),
...
React.createElement(“div”, { style: { display: “flex”, gap: 7, marginBottom: 10, flexWrap: “wrap” } }, STRUCTURES.map(s => (React.createElement(“button”, { key: s, onClick: () => insertSection(s), style: { padding: “5px 12px”, background: “rgba(255,255,255,0.5)”, border: “1px solid rgba(255,255,255,0.1)”, borderRadius: 20, color: “rgba(255,255,255,0.5)”, fontSize: 11, cursor: “pointer” } },
“+ “,
s)))),
...
“#”,
t,
React.createElement(“button”, { onClick: () => setTags(p => p.filter((*, j) => j !== i)), style: { background: “none”, border: “none”, color: “rgba(255,255,255,0.4)”, fontSize: 14, cursor: “pointer”, lineHeight: 1, padding: 0 } }, “\u00D7”))))),
React.createElement(“div”, { style: { display: “flex”, gap: 8, marginBottom: 14 } },
React.createElement(“input”, { value: tagIn, onChange: e => setTagIn(e.target.value), onKeyDown: e => { if (e.key === “Enter”)
...
React.createElement(“div”, { style: { display: “flex”, alignItems: “center”, justifyContent: “space-between”, background: “rgba(255,255,255,0.3)”, borderRadius: 14, padding: “13px 16px”, marginBottom: 20 } },
React.createElement(“div”, null,
React.createElement(“div”, { style: { fontSize: 13, fontWeight: 600 } }, “Open for Collaboration”),
...
const filteredProjects = DISCOVER_PROJECTS.filter(p => !q || p.title.toLowerCase().includes(q) ||
p.type.toLowerCase().includes(q) ||
p.status.toLowerCase().includes(q) ||
p.location.toLowerCase().includes(q));
const filteredCalls = DISCOVER_CALLS.filter(c => !q || c.title.toLowerCase().includes(q) ||
...
React.createElement(“div”, { style: { position: “relative” } },
React.createElement(“span”, { style: { position: “absolute”, left: 13, top: “50%”, transform: “translateY(-50%)”, fontSize: 14, opacity: 0.4 } }, “\uD83D\uDD0D”),
React.createElement(“input”, { value: query, onChange: e => setQuery(e.target.value), placeholder: “Search people, projects, roles\u2026”, style: Object.assign(Object.assign({}, inputSt), { paddingLeft: 38, marginBottom: 0 }) }),
query && (React.createElement(“button”, { onClick: () => setQuery(””), style: { position: “absolute”, right: 12, top: “50%”, transform: “translateY(-50%)”, background: “none”, border: “none”, color: “rgba(255,255,255,0.4)”, fontSize: 16, cursor: “pointer” } }, “\u00D7”)))),
React.createElement(“div”, { style: { display: “flex”, borderBottom: “1px solid rgba(255,255,255,0.08)”, flexShrink: 0, marginTop: 12 } }, tabs.map(t => (React.createElement(“button”, { key: t.key, onClick: () => setTab(t.key), style: { flex: 1, padding: “11px 0”, background: “none”, border: “none”,
color: tab === t.key ? “#c9a84c” : “rgba(255,255,255,0.42)”,
fontWeight: tab === t.key ? 700 : 400, fontSize: 13, cursor: “pointer”,
borderBottom: tab === t.key ? “2px solid #c9a84c” : “2px solid transparent” } }, t.label)))),
React.createElement(“div”, { style: { flex: 1, overflowY: “auto”, padding: “14px 16px 80px” } },
tab === “people” && (loadingUsers && realUsers.length === 0
? React.createElement(“div”, { style: { textAlign: “center”, padding: “48px 0”, color: “rgba(255,255,255,0.4)” } },
React.createElement(“div”, { style: { fontSize: 13 } }, “Loading people\u2026”))
: filteredPeople.length === 0
? React.createElement(EmptyState, { query: query, type: “people” })
: filteredPeople.map(p => (React.createElement(“div”, { key: p.id, style: { background: “rgba(255,255,255,0.4)”, border: “1px solid rgba(255,255,255,0.08)”, borderRadius: 18, padding: “16px”, marginBottom: 12 } },
React.createElement(“div”, { style: { display: “flex”, gap: 12, alignItems: “flex-start”, marginBottom: 10 } },
React.createElement(“div”, { style: { width: 52, height: 52, borderRadius: 14, background: `linear-gradient(135deg,${p.accent}44,${p.accent}22)`, border: `2px solid ${p.accent}55`, display: “flex”, alignItems: “center”, justifyContent: “center”, fontWeight: 700, fontSize: 16, flexShrink: 0 } }, p.avatar),
React.createElement(“div”, { style: { flex: 1, minWidth: 0 } },
React.createElement(“div”, { style: { display: “flex”, alignItems: “center”, justifyContent: “space-between”, gap: 8 } },
React.createElement(“div”, null,
React.createElement(“div”, { style: { fontWeight: 700, fontSize: 15, fontFamily: “‘Cormorant Garamond’,serif” } }, p.name),
React.createElement(“div”, { style: { fontSize: 11, color: p.accent, fontWeight: 600 } }, p.role),
React.createElement(“div”, { style: { fontSize: 11, color: “rgba(255,255,255,0.35)”, marginTop: 1 } },
“\uD83D\uDCCD “,
p.location)),
React.createElement(“button”, { onClick: () => toggleFollow(p.id), style: { flexShrink: 0, padding: “7px 14px”, background: (followed[p.id] || p.following) ? “rgba(255,255,255,0.08)” : p.accent, border: `1px solid ${(followed[p.id] || p.following) ? "rgba(255,255,255,0.15)" : p.accent}`, borderRadius: 20, color: (followed[p.id] || p.following) ? “rgba(255,255,255,0.6)” : “#1a0a2e”, fontWeight: 700, fontSize: 11, cursor: “pointer” } }, (followed[p.id] || p.following) ? “Following” : “Follow”)))),
...
React.createElement(“div”, { style: { background: `linear-gradient(135deg,${p.accent}22,${p.accent}0a)`, padding: “14px 16px”, borderBottom: “1px solid rgba(255,255,255,0.6)”, display: “flex”, alignItems: “center”, justifyContent: “space-between” } },
React.createElement(“div”, null,
...
React.createElement(“span”, { style: { background: “rgba(255,255,255,0.6)”, color: “rgba(255,255,255,0.5)”, borderRadius: 20, padding: “3px 11px”, fontSize: 11 } },
“\uD83D\uDCCD “,
p.location),
React.createElement(“span”, { style: { background: “rgba(255,255,255,0.6)”, color: “rgba(255,255,255,0.5)”, borderRadius: 20, padding: “3px 11px”, fontSize: 11 } },
“\uD83D\uDC65 “,
...
: filteredCalls.map(c => (React.createElement(“div”, { key: c.id, style: { background: “rgba(255,255,255,0.4)”, border: “1px solid rgba(255,255,255,0.08)”, borderRadius: 18, padding: “16px”, marginBottom: 12 } },
React.createElement(“div”, { style: { display: “flex”, justifyContent: “space-between”, alignItems: “flex-start”, marginBottom: 8 } },
React.createElement(“div”, { style: { flex: 1, minWidth: 0, marginRight: 10 } },
React.createElement(“div”, { style: { fontWeight: 700, fontSize: 15, fontFamily: “‘Cormorant Garamond’,serif”, lineHeight: 1.3 } }, c.title),
React.createElement(“div”, { style: { fontSize: 12, color: “rgba(255,255,255,0.4)”, marginTop: 2 } }, c.company)),
React.createElement(“div”, { style: { display: “flex”, flexDirection: “column”, alignItems: “flex-end”, gap: 4, flexShrink: 0 } },
React.createElement(“span”, { style: { background: c.type === “Audition” ? “rgba(201,168,76,0.2)” : “rgba(76,184,196,0.2)”, color: c.type === “Audition” ? “#c9a84c” : “#4cb8c4”, borderRadius: 20, padding: “3px 10px”, fontSize: 10, fontWeight: 700 } }, c.type),
React.createElement(“span”, { style: { fontSize: 10, color: “rgba(255,255,255,0.35)” } },
“\u23F0 “,
c.deadline))),
React.createElement(“div”, { style: { display: “flex”, gap: 6, marginBottom: 10 } },
c.paid && React.createElement(“span”, { style: { background: “rgba(74,222,128,0.15)”, color: “#4ade80”, borderRadius: 20, padding: “2px 9px”, fontSize: 10, fontWeight: 700 } }, “\uD83D\uDCB0 Paid”),
...
radius,
“ MILES”),
results.map((s, i) => (React.createElement(“div”, { key: i, style: { background: “rgba(255,255,255,0.4)”, border: `1px solid ${s.accent}33`, borderRadius: 18, overflow: “hidden”, marginBottom: 14 } },
s.image && (React.createElement(“div”, { style: { height: 120, overflow: “hidden”, position: “relative” } },
React.createElement(“img”, { src: s.image, alt: s.title, style: { width: “100%”, height: “100%”, objectFit: “cover”, display: “block” } }),
...
React.createElement(“div”, { style: { background: s.image ? `rgba(0,0,0,0.2)` : `linear-gradient(135deg,${s.accent}18,${s.accent}08)`, padding: “14px 16px”, borderBottom: “1px solid rgba(255,255,255,0.6)”, display: “flex”, alignItems: “flex-start”, justifyContent: “space-between”, gap: 10 } },
React.createElement(“div”, { style: { flex: 1, minWidth: 0 } },
...
React.createElement(“span”, { style: { background: “rgba(255,255,255,0.6)”, color: “rgba(255,255,255,0.5)”, borderRadius: 20, padding: “3px 10px”, fontSize: 10 } }, s.tickets)),
...
if (evt.type === “content_block_delta” && ((_a = evt.delta) === null || _a === void 0 ? void 0 : _a.type) === “text_delta”) {
...
const build = () => {
if (!sceneIn.trim()) {
show(“Enter a scene prompt first”);
return;
}
...
return (React.createElement(“div”, { style: { padding: “22px 18px 80px”, overflowY: “auto”, height: “100%” } },
React.createElement(“div”, { style: { fontSize: 28, fontWeight: 700, fontFamily: “‘Cormorant Garamond’,serif”, marginBottom: 6 } }, “AI Studio”),
React.createElement(“div”, { style: { fontSize: 13, color: “rgba(255,255,255,0.38)”, marginBottom: 24 } }, “Supercharge your creative process”),
React.createElement(“div”, { style: { background: “rgba(201,168,76,0.6)”, border: “1px solid rgba(201,168,76,0.2)”, borderRadius: 18, padding: “18px”, marginBottom: 16 } },
...
sub === “ai” && React.createElement(AIScreen, { show: show }),
...
? tapeRows.map(t => { var _a; return ({ id: t.id, title: t.title, date: ((_a = t.created_at) === null || _a === void 0 ? void 0 : _a.slice(0, 10)) || “”, status: t.status || “pending”, duration: “0:0” }); })
: []);
}
});
}, []);
...
const token = localStorage.getItem(“sb_token”);
if (!token) {
console.warn(“No auth token for upload”);
return null;
}
if (!file) {
...
setMedia(p => p.map(m => m.id === tempId ? Object.assign(Object.assign({}, m), { progress: pct }) : m));
});
if (storageUrl) {
// Replace temp local URL with permanent storage URL
setMedia(p => p.map(m => m.id === tempId ? Object.assign(Object.assign({}, m), { url: storageUrl, uploading: false, progress: null }) : m));
// Save to database
...
setTapes(p => p.map(t => t.id === tempId ? Object.assign(Object.assign({}, t), { progress: pct }) : t));
});
if (storageUrl) {
setTapes(p => p.map(t => t.id === tempId ? Object.assign(Object.assign({}, t), { uploading: false, progress: null, url: storageUrl }) : t));
...
if (subPage === “settings”)
return React.createElement(SettingsPage, { onBack: () => setSubPage(“main”), show: show });
if (subPage === “privacy”)
return React.createElement(PrivacyPage, { privacy: privacy, setPrivacy: setPrivacy, onBack: () => setSubPage(“main”), show: show });
return (React.createElement(“div”, { style: { height: “calc(100vh - 72px)”, overflowY: “auto”, position: “relative” } },
React.createElement(“div”, { style: { background: “linear-gradient(160deg,#1a0a2e,#2d1040,#0d1a2e)”, height: 160, position: “relative” } },
React.createElement(“label”, { style: { position: “absolute”, inset: 0, cursor: “pointer”, display: “flex”, alignItems: “center”, justifyContent: “center” } },
...
setProfile(p => (Object.assign(Object.assign({}, p), { banner: finalUrl })));
...
: React.createElement(“span”, { style: { fontSize: 11, color: “rgba(255,255,255,0.25)”, letterSpacing: “0.08em” } }, “TAP TO ADD COVER PHOTO”)),
React.createElement(“label”, { style: { position: “absolute”, bottom: -36, left: 20, cursor: “pointer” } },
React.createElement(“input”, { type: “file”, accept: “image/*”, style: { display: “none” }, onChange: async (e) => {
var _a;
const f = (_a = e.target.files) === null || _a === void 0 ? void 0 : _a[0];
if (!f)
...
: “AR”),
React.createElement(“div”, { style: { position: “absolute”, bottom: 2, right: 2, width: 20, height: 20, background: “#c9a84c”, borderRadius: “50%”, display: “flex”, alignItems: “center”, justifyContent: “center”, fontSize: 11 } }, “\uD83D\uDCF7”))),
React.createElement(“div”, { style: { padding: “48px 18px 16px”, display: “flex”, alignItems: “flex-start”, justifyContent: “space-between” } },
React.createElement(“div”, null,
React.createElement(“div”, { style: { fontSize: 22, fontWeight: 700, fontFamily: “‘Cormorant Garamond’,serif” } }, profile.name),
React.createElement(“div”, { style: { fontSize: 12, color: “#c9a84c”, marginTop: 1 } }, profile.role),
React.createElement(“div”, { style: { fontSize: 11, color: “rgba(255,255,255,0.38)”, marginTop: 1 } },
“\uD83D\uDCCD “,
profile.location)),
React.createElement(“div”, { style: { display: “flex”, gap: 8 } },
React.createElement(“button”, { onClick: () => setSubPage(“edit”), style: { padding: “8px 14px”, background: “rgba(201,168,76,0.15)”, border: “1px solid rgba(201,168,76,0.3)”, borderRadius: 10, color: “#c9a84c”, fontWeight: 700, fontSize: 12, cursor: “pointer” } }, “Edit”),
React.createElement(“button”, { onClick: () => setSubPage(“settings”), style: { width: 34, height: 34, background: “rgba(255,255,255,0.6)”, border: “1px solid rgba(255,255,255,0.1)”, borderRadius: 10, color: “rgba(255,255,255,0.6)”, fontSize: 16, cursor: “pointer” } }, “\u2699”))),
React.createElement(“div”, { style: { padding: “0 18px 12px”, fontSize: 13, color: “rgba(255,255,255,0.62)”, lineHeight: 1.65 } }, profile.bio),
profile.website && React.createElement(“div”, { style: { padding: “0 18px 14px”, fontSize: 12, color: “#c9a84c” } },
“\uD83D\uDD17 “,
profile.website),
...
React.createElement(“input”, { type: “file”, accept: “image/*,video/*”, multiple: true, style: { display: “none” }, onChange: handleMediaUpload }),
“\uD83D\uDCF8 Add Photo”),
React.createElement(“label”, { style: { flex: 1, display: “flex”, alignItems: “center”, justifyContent: “center”, gap: 8, padding: “11px”, background: “rgba(76,184,196,0.1)”, border: “1px dashed rgba(76,184,196,0.4)”, borderRadius: 12, cursor: “pointer”, color: “#4cb8c4”, fontWeight: 700, fontSize: 13 } },
React.createElement(“input”, { type: “file”, accept: “video/*”, style: { display: “none” }, onChange: handleMediaUpload }),
“\uD83C\uDFAC Add Video”)),
React.createElement(“div”, { style: { display: “grid”, gridTemplateColumns: “repeat(3,1fr)”, gap: 3 } },
media.map(item => (React.createElement(“div”, { key: item.id, style: { position: “relative”, aspectRatio: “1”, borderRadius: 8, overflow: “hidden”, background: “#1a0a2e”, cursor: “pointer” }, onClick: () => setLightbox(item) },
item.type === “photo”
? React.createElement(“img”, { src: item.url, style: { width: “100%”, height: “100%”, objectFit: “cover” } })
: (React.createElement(“div”, { style: { width: “100%”, height: “100%”, background: “linear-gradient(160deg,#1a0f1f,#2d1040)”, display: “flex”, flexDirection: “column”, alignItems: “center”, justifyContent: “center”, gap: 6 } },
...
React.createElement(“div”, { style: { fontSize: 14 } }, “No photos or videos yet”),
React.createElement(“div”, { style: { fontSize: 12, marginTop: 4 } }, “Tap Add Photo to get started”)))))),
bioTab === “tapes” && (React.createElement(“div”, { style: { padding: “14px 16px 100px” } },
React.createElement(“label”, { style: { display: “flex”, alignItems: “center”, justifyContent: “center”, gap: 8, padding: “13px”, background: “linear-gradient(135deg,rgba(239,68,68,0.12),rgba(201,168,76,0.08))”, border: “1px dashed rgba(239,68,68,0.4)”, borderRadius: 14, cursor: “pointer”, marginBottom: 16 } },
React.createElement(“input”, { type: “file”, accept: “video/*”, style: { display: “none” }, onChange: handleTapeUpload }),
React.createElement(“span”, { style: { fontSize: 20 } }, “\u23FA”),
React.createElement(“div”, null,
React.createElement(“div”, { style: { fontSize: 13, fontWeight: 700, color: “#fff” } }, “Upload Self Tape”),
React.createElement(“div”, { style: { fontSize: 11, color: “rgba(255,255,255,0.4)” } }, “MP4, MOV, or any video file”))),
React.createElement(“div”, { style: { background: “rgba(201,168,76,0.7)”, border: “1px solid rgba(201,168,76,0.2)”, borderRadius: 12, padding: “12px 14px”, marginBottom: 16 } },
React.createElement(“div”, { style: { fontSize: 10, fontWeight: 700, color: “#c9a84c”, letterSpacing: “0.1em”, marginBottom: 5 } }, “SELF TAPE TIPS”),
React.createElement(“div”, { style: { fontSize: 12, color: “rgba(255,255,255,0.6)”, lineHeight: 1.6 } },
“\u2713 Slate first \u2014 name, role, representation”,
React.createElement(“br”, null),
“\u2713 Plain background, good front lighting”,
React.createElement(“br”, null),
“\u2713 Frame from mid-chest up”,
React.createElement(“br”, null),
“\u2713 Slate under 10 seconds”)),
tapes.length === 0 ? (React.createElement(“div”, { style: { textAlign: “center”, padding: “48px 0”, color: “rgba(255,255,255,0.25)” } },
React.createElement(“div”, { style: { fontSize: 36, marginBottom: 10 } }, “\uD83C\uDFAC”),
React.createElement(“div”, { style: { fontSize: 14 } }, “No self tapes yet”))) : tapes.map(t => (React.createElement(“div”, { key: t.id, style: { background: “rgba(255,255,255,0.4)”, border: “1px solid rgba(255,255,255,0.08)”, borderRadius: 16, padding: “14px 16px”, marginBottom: 12 } },
React.createElement(“div”, { style: { display: “flex”, gap: 12, alignItems: “flex-start” } },
React.createElement(“div”, { style: { width: 52, height: 52, borderRadius: 12, background: “linear-gradient(135deg,#1a0f1f,#2d1040)”, display: “flex”, alignItems: “center”, justifyContent: “center”, fontSize: 24, flexShrink: 0 } }, “\uD83C\uDFAC”),
React.createElement(“div”, { style: { flex: 1, minWidth: 0 } },
React.createElement(“div”, { style: { display: “flex”, justifyContent: “space-between”, alignItems: “flex-start” } },
React.createElement(“div”, { style: { fontWeight: 700, fontSize: 14, fontFamily: “‘Cormorant Garamond’,serif”, lineHeight: 1.3 } }, t.title),
...
“ “,
label))))),
lightbox && (React.createElement(“div”, { onClick: () => setLightbox(null), style: { position: “fixed”, inset: 0, background: “rgba(0,0,0,0.92)”, zIndex: 300, display: “flex”, flexDirection: “column”, alignItems: “center”, justifyContent: “center” } },
React.createElement(“button”, { onClick: () => setLightbox(null), style: { position: “absolute”, top: 20, right: 20, background: “rgba(255,255,255,0.12)”, border: “none”, borderRadius: “50%”, width: 36, height: 36, color: “#fff”, fontSize: 18, cursor: “pointer” } }, “\u00D7”),
lightbox.type === “photo”
? React.createElement(“img”, { src: lightbox.url, style: { maxWidth: “96vw”, maxHeight: “80vh”, borderRadius: 14, objectFit: “contain” } })
: React.createElement(“div”, { style: { width: “80vw”, aspectRatio: “16/9”, background: “#111”, borderRadius: 14, display: “flex”, alignItems: “center”, justifyContent: “center”, fontSize: 48 } }, “\uD83C\uDFAC”),
React.createElement(“div”, { style: { marginTop: 14, fontSize: 13, color: “rgba(255,255,255,0.6)”, textAlign: “center” } }, lightbox.caption)))));
}
...
multiline
? React.createElement(“textarea”, { value: draft[key] || “”, onChange: e => setDraft(p => (Object.assign(Object.assign({}, p), { [key]: e.target.value }))), rows: 3, style: Object.assign(Object.assign({}, inputSt), { resize: “none” }), placeholder: placeholder })
: React.createElement(“input”, { value: draft[key] || “”, onChange: e => setDraft(p => (Object.assign(Object.assign({}, p), { [key]: e.target.value }))), style: inputSt, placeholder: placeholder })));
return (React.createElement(SubPage, { title: “Edit Profile”, onBack: onBack },
...
const r = new FileReader();
r.onload = ev => {
setDraft(p => (Object.assign(Object.assign({}, p), { avatar: ev.target.result })));
setProfile(p => (Object.assign(Object.assign({}, p), { avatar: ev.target.result })));
};
r.readAsDataURL(f);
} }),
React.createElement(“div”, { style: { width: 82, height: 82, borderRadius: “50%”, border: “3px solid #c9a84c”, overflow: “hidden”, background: “rgba(201,168,76,0.2)”, display: “flex”, alignItems: “center”, justifyContent: “center”, fontWeight: 700, fontSize: 28 } }, (draft.avatar || profile.avatar)
? React.createElement(“img”, { src: draft.avatar || profile.avatar, style: { width: “100%”, height: “100%”, objectFit: “cover” } })
: “AR”),
...
return (React.createElement(“div”, { style: { padding: “18px 16px 80px”, overflowY: “auto”, height: “100%” } },
...
“\uD83D\uDC65 “,
room.listeners)),
React.createElement(“div”, { style: { display: “flex”, gap: 1.5, height: 24, alignItems: “flex-end”, marginBottom: 12, opacity: 0.6 } }, Array.from({ length: 32 }).map((*, i) => (React.createElement(“div”, { key: i, className: “bar”, style: { flex: 1, borderRadius: 1, height: `${25 + Math.sin(i * 0.7 + room.id) * 55}%`, background: room.accent } })))),
...
return (React.createElement(“div”, { style: { position: “fixed”, inset: 0, background: “#08080f”, zIndex: 200, display: “flex”, flexDirection: “column” } },
...
useEffect(() => { var _a; (_a = endRef.current) === null || _a === void 0 ? void 0 : *a.scrollIntoView({ behavior: “smooth” }); }, [thread, dbMsgs]);
...
React.createElement(“button”, { onClick: () => { if (thread)
setThread(null);
else
onClose(); }, style: { background: “none”, border: “none”, color: “rgba(255,255,255,0.6)”, fontSize: 20, cursor: “pointer” } }, “\u2190”),
...
React.createElement(“div”, { ref: endRef })),
React.createElement(“div”, { style: { padding: “10px 14px 28px”, borderTop: “1px solid rgba(255,255,255,0.7)”, display: “flex”, gap: 10 } },
React.createElement(“input”, { value: input, onChange: e => setInput(e.target.value), onKeyDown: e => { if (e.key === “Enter”)
sendMsg(conv); }, placeholder: “Message\u2026”, style: { flex: 1, padding: “11px 13px”, background: “rgba(255,255,255,0.7)”, border: “1px solid rgba(255,255,255,0.12)”, borderRadius: 12, color: “#fff”, fontSize: 13, outline: “none” } }),
React.createElement(“button”, { onClick: () => sendMsg(conv), style: { padding: “11px 16px”, background: conv.accent, color: “#1a0a2e”, border: “none”, borderRadius: 12, fontWeight: 700, fontSize: 13, cursor: “pointer” } }, “Send”)))) : (React.createElement(“div”, { style: { flex: 1, overflowY: “auto” } }, messages.map(m => {
var _a;
return (React.createElement(“div”, { key: m.id, onClick: () => { setThread(m.id); markRead(m.id); }, style: { display: “flex”, alignItems: “center”, gap: 14, padding: “16px 18px”, borderBottom: “1px solid rgba(255,255,255,0.5)”, cursor: “pointer” } },
...
React.createElement(“div”, { style: { display: “flex”, background: “rgba(0,0,0,0.4)”, borderBottom: “1px solid rgba(255,255,255,0.08)”, overflowX: “auto” } }, SUBS.map(s => (React.createElement(“button”, { key: s.key, onClick: () => setSub(s.key), style: { flex: “0 0 auto”, padding: “12px 18px”, background: “none”, border: “none”, color: sub === s.key ? “#c9a84c” : “rgba(255,255,255,0.45)”, fontWeight: sub === s.key ? 700 : 400, fontSize: 13, cursor: “pointer”, borderBottom: sub === s.key ? “2px solid #c9a84c” : “2px solid transparent”, whiteSpace: “nowrap” } }, s.label)))),
React.createElement(“div”, { style: { flex: 1, overflowY: “auto” } },
...
“\uD83D\uDCCD “,
c.location),
React.createElement(“div”, { style: { fontSize: 12, color: “rgba(255,255,255,0.6)”, background: “rgba(255,255,255,0.4)”, borderRadius: 10, padding: “10px 12px”, marginBottom: 14, lineHeight: 1.5 } },
...
audFilter,
“ auditions”),
React.createElement(“div”, { style: { fontSize: 13 } }, “Add one or track from a Casting Call”))) : filteredAuditions.map(a => (React.createElement(“div”, { key: a.id, style: { background: “rgba(255,255,255,0.4)”, border: “1px solid rgba(255,255,255,0.08)”, borderRadius: 18, padding: “16px”, marginBottom: 12 } },
...
“\uD83D\uDCCD “,
a.location),
a.prep && React.createElement(“div”, { style: { fontSize: 12, background: “rgba(255,255,255,0.4)”, borderRadius: 10, padding: “8px 10px”, marginTop: 4 } },
...
React.createElement(“div”, { style: { fontSize: 13 } }, “Hit Record to add your first one”))) : selfTapes.map(t => (React.createElement(“div”, { key: t.id, style: { background: “rgba(255,255,255,0.4)”, border: “1px solid rgba(255,255,255,0.08)”, borderRadius: 18, padding: “16px”, marginBottom: 12 } },
React.createElement(“div”, { style: { display: “flex”, gap: 12 } },
...
React.createElement(“div”, null,
React.createElement(“div”, { style: { fontSize: 20, fontWeight: 700, fontFamily: “‘Cormorant Garamond’,serif” } }, “Alex Rivera”),
React.createElement(“div”, { style: { fontSize: 12, color: “#c9a84c” } }, “Composer \u00B7 Lyricist \u00B7 Performer”),
React.createElement(“div”, { style: { fontSize: 11, color: “rgba(255,255,255,0.4)” } }, “San Diego, CA”))),
...
“ \u00B7 “,
c.year)),
React.createElement(“button”, { onClick: () => removeCredit(i), style: { background: “none”, border: “none”, color: “rgba(255,255,255,0.25)”, fontSize: 16, cursor: “pointer” } }, “\u00D7”))))),
React.createElement(ResumeSection, { title: “Skills & Special”, onAdd: () => show(“Skills editor coming soon”) },
...
return (React.createElement(CastingModal, { title: “Post Casting Call”, onClose: onClose, onSubmit: () => {
if (!f.title.trim()) {
alert(“Please enter a production title.”);
return;
}
if (!f.role.trim()) {
...
React.createElement(“div”, { style: { display: “grid”, gridTemplateColumns: “1fr 1fr”, gap: 12 } },
React.createElement(CField, { label: “ROLE NAME” },
React.createElement(“input”, { value: f.role, onChange: e => u(“role”, e.target.value), style: darkInput, placeholder: “e.g. The Witch” })),
React.createElement(CField, { label: “TYPE” },
React.createElement(“select”, { value: f.type, onChange: e => u(“type”, e.target.value), style: darkInput },
React.createElement(“option”, null, “Lead”),
React.createElement(“option”, null, “Supporting”),
React.createElement(“option”, null, “Ensemble”),
React.createElement(“option”, null, “Understudy”)))),
React.createElement(“div”, { style: { display: “grid”, gridTemplateColumns: “1fr 1fr”, gap: 12 } },
React.createElement(CField, { label: “VOICE TYPE” },
React.createElement(“select”, { value: f.voice, onChange: e => u(“voice”, e.target.value), style: darkInput },
React.createElement(“option”, null, “Any”),
React.createElement(“option”, null, “Soprano”),
React.createElement(“option”, null, “Mezzo-Soprano”),
React.createElement(“option”, null, “Alto”),
React.createElement(“option”, null, “Tenor”),
React.createElement(“option”, null, “Baritone”),
React.createElement(“option”, null, “Bass”))),
React.createElement(CField, { label: “COMP” },
React.createElement(“select”, { value: f.comp, onChange: e => u(“comp”, e.target.value), style: darkInput },
...
React.createElement(CField, { label: “DATE & LOCATION” },
React.createElement(“input”, { value: f.date, onChange: e => u(“date”, e.target.value), style: darkInput, placeholder: “April 20 \u00B7 The Old Globe” })),
React.createElement(CField, { label: “WHAT TO PREPARE” },
React.createElement(“textarea”, { value: f.prep, onChange: e => u(“prep”, e.target.value), rows: 2, style: Object.assign(Object.assign({}, darkInput), { resize: “none” }), placeholder: “16 bars up-tempo + ballad\u2026” })),
React.createElement(“label”, { style: { display: “flex”, alignItems: “center”, gap: 10, cursor: “pointer” } },
React.createElement(“input”, { type: “checkbox”, checked: f.selftape, onChange: e => u(“selftape”, e.target.checked), style: { width: 16, height: 16, accentColor: “#c9a84c” } }),
React.createElement(“span”, { style: { fontSize: 13, color: “rgba(255,255,255,0.7)” } }, “Accept self tapes / remote submissions”))));
}
...
React.createElement(“div”, { style: { flex: 1, overflowY: “auto”, padding: “16px 20px”, display: “flex”, flexDirection: “column”, gap: 12 } }, children),
React.createElement(“div”, { style: { padding: “14px 20px 28px”, borderTop: “1px solid rgba(255,255,255,0.08)”, display: “flex”, gap: 10 } },
React.createElement(“button”, { onClick: onClose, style: { flex: 1, padding: “13px”, background: “rgba(255,255,255,0.5)”, border: “1px solid rgba(255,255,255,0.1)”, borderRadius: 12, color: “rgba(255,255,255,0.6)”, fontWeight: 600, fontSize: 14, cursor: “pointer” } }, “Cancel”),
...
React.createElement(“div”, { style: { width: 36, height: 4, background: “rgba(255,255,255,0.2)”, borderRadius: 2, margin: “0 auto 16px” } }),
children)));
}
function SubPage({ title, onBack, children }) {
return (React.createElement(“div”, { style: { height: “calc(100vh - 72px)”, display: “flex”, flexDirection: “column” }, className: “fade-in” },
...
React.createElement(“div”, { style: { fontFamily: “‘Cormorant Garamond’,serif”, fontWeight: 700, fontSize: 20 } }, title)),
React.createElement(“div”, { style: { flex: 1, overflowY: “auto”, padding: “20px 18px 40px” } }, children)));
}
...
// Style helpers
const inputSt = { width: “100%”, padding: “11px 14px”, background: “rgba(255,255,255,0.6)”, border: “1px solid rgba(255,255,255,0.12)”, borderRadius: 12, color: “#fff”, fontSize: 13, outline: “none”, marginBottom: 0 };
...
const ghostBtn = { width: “100%”, padding: “12px”, background: “rgba(255,255,255,0.5)”, border: “1px solid rgba(255,255,255,0.12)”, borderRadius: 14, color: “rgba(255,255,255,0.6)”, fontWeight: 600, fontSize: 14, cursor: “pointer”, marginBottom: 10 };
// Utility
